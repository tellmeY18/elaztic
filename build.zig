...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "elaztic" is the name you will use in your source code to
                // import this module (e.g. `@import("elaztic")`). The name is
    ...
    // API integration tests (M4 — index management, document CRUD, search, count, aliases)
    const api_integration_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/integration/api_integration.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "elaztic", .module = mod },
    ...
    const run_api_integration_tests = b.addRunArtifact(api_integration_tests);

    // Bulk integration tests (M5 — bulk indexer batching, auto-flush, mixed actions)
    const bulk_integration_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/integration/bulk_integration.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "elaztic", .module = mod },
